...
useEffect(() => {
    ...
    const storeBookIds = getStoredBook();
    if(books.length > 0){
        // const booksApplied = books.filter(book => storeBookIds.includes(book.id));
  ...
  <summary className="m-1 btn text-lg font-semibold text-white bg-[#23BE0A] px-10">Sort By <IoIosArrowDown /></summary>
  <ul className=" bg-[#1313130d] menu dropdown-content z-[10] rounded-box w-full">
    <li className="text-[#131313cc] font-semibold"><a>Rating</a></li>
    <li className="text-[#131313cc] font-semibold"><a>Number of pages</a></li>
    <li className="text-[#131313cc] font-semibold"><a>Publisher year</a></li>
