...
const Book = ({book}) => {
const {image, tags, bookName, category, author, rating}= book;

    return (
<Link to="/details" className="card p-6 border rounded-xl">
...
<h3 className='text-[#23BE0A] font-work-sans text-base font-medium bg-[#23be0a0d] py-2 px-4 rounded-[30px]'>{tags[1]}</h3>
  ...
  <h6 className='text-[#131313cc] font-work-sans font-medium text-base flex items-center gap-2'>{rating} <IoIosStarOutline></IoIosStarOutline></h6>
